...
URCorner = (570, 0)  # Upper Right (1061, 136)
BLCorner = (0, 325)  # Bottom Left (200, 626)
BRCorner = (570, 325)  # Bottom Right (1066, 609)
...
rod_x_asymptote_pixels = [401, 254, 105, 29]  #rod 0 through 3, rod 0 is closest to PC (offensive 3 line)
...
while True:  #infinite loop to keep processing data
    ...
    if not ret:
        ...
        break
    frame = imutils.resize(frame, width=new_width)  #resize frame, so whole table is shown after resolution change above
    frame = AntiFisheye.undistort_fisheye_image(frame, K_scaled, D) #anti-fisheye
    frame = frame[60:385, 115:685] #crops image to region of interest (table)
