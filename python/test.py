...
while True:
    ...
    frame = AntiFisheye.undistort_fisheye_image(frame,
        np.array([[968.82202387, 0.0, 628.92706997], [0.0, 970.56156502, 385.82007021], [0.0, 0.0, 1.0]]),
        np.array([-0.04508764, -0.01990902, 0.08263842, -0.0700435])
    )
    frame = frame[120:590, 160:1000]  # Crop
