...
# Green highlighter or ball HSV range
lower_bound = np.array([35, 100, 100])  # Lower bound of HSV for green
upper_bound = np.array([85, 255, 255])  # Upper bound of HSV for green
