...
//   switch (servoIndex) {
//     case 0:
//       servo1.write(int(40-(angle*4.3/5))); // 3/5 to accomodate for gear ratio
//       break;
//     case 1:
//       servo2.write(int(angle+22));
//       break;
//     case 2:
//       servo3.write(int(50-(angle*2.1/5))); // 3/5 to accomodate for gear ratio
//       break;
//     case 3:
//       servo4.write(int(angle+28));
//       break;
//   }
// }
...
//         case 0:
//           setServoPosition(i, angle1); // Initial vertical position
//           interval = 215;
//           break;
//         case 1:
...
//           break;
//         case 2:
//           setServoPosition(i, 0); // Return to initial vertical position
...
// //   String data = String(motorCurrent[0], 1) + "," +
// //   String(motorCurrent[1], 1) + "," +
// //   String(motorCurrent[2], 1) + "," +
// //   String(motorCurrent[3], 1) + "," +
// //   String(servoCurrent[0], 1) + "," +
// //   String(servoCurrent[1], 1) + "," +
// //   String(servoCurrent[2], 1) + "," +
// //   String(servoCurrent[3], 1);

// // Serial.println(data);

// coms.updateCurrentMSVals(motorCurrent,servoCurrent);
// coms.sendDataBack(motorCurrent,servoCurrent);
