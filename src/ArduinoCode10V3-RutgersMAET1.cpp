...
// long interval = 20; // Interval at which to move servo (milliseconds)
...
//         case 0:
//           setServoPosition(i, 10); // Initial vertical position
//           interval = 50;
//           break;
//         case 1:
//           setServoPosition(i, 10); // Slightly back
//           interval = 50;
//           break;
//         case 2:
//           setServoPosition(i, 10); // Return to initial vertical position
