...
// const int holdAngle = -74;
// const int shotAngle = 10;   // full 360 angle from trap angle
// const int receiveAngle = 8;
// const int home = 0;
// const int rodIndex = 1; // change for which servo needed (only for servo 1 or 3 since they turn opposite directions)
// const int rodIndex2 = 0; //player receiving the ball
