...
void loop() {
  ...
  stepper1.moveTo(coms.motorPositions[0], 1.0);
  stepper2.moveTo(coms.motorPositions[1], 1.0);
  stepper3.moveTo(coms.motorPositions[2], 1.0);
  stepper4.moveTo(coms.motorPositions[3], 1.0);
  stepper1.update();
  stepper2.update();
  stepper3.update();
  stepper4.update();
